 ...
 * @author ZenBook
 */
public class MsgDatosIncorrectos2 extends javax.swing.JFrame {

    /**
     * Creates new form MsgDatosIncorrectos
     */
    private Login2 login;
    public MsgDatosIncorrectos2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MsgDatosIncorrectos2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MsgDatosIncorrectos2().setVisible(true);
            }
        });
    }
